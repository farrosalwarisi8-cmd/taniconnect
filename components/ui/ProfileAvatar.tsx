...
export function ProfileAvatar() {
    ...
    switch (activeRole) {
      ...
      case 'pembeli':
        return [
          ...
          { href: '/pembeli/keranjang', icon: '🛒', label: 'Keranjang' },
          { href: '/pembeli/marketplace', icon: '🛍️', label: 'Marketplace' },
        ]
      case 'penyedia_alat':
        return [
  ...
  return (
    // PENAMBAHAN: Wrapper flex agar CartButton dan Avatar sejajar
    <div className="flex items-center gap-1.5">
      {/* Cart button — auto-hide kalau belum login (self-contained) */}
      <CartButton variant="compact" />

      {/* Original avatar dropdown — tidak diubah di dalamnya */}
